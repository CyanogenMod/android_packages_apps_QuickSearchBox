...
// This code is copied from frameworks/base/core/java/android/server/search/SearchableInfo.java
...
public final class SearchableInfo implements Parcelable {
    ...
    private SearchableInfo(Context activityContext, AttributeSet attr, final ComponentName cName) {
        ...
        TypedArray a = activityContext.obtainStyledAttributes(attr,
                styleable.Searchable);
        mSearchMode = a.getInt(styleable.Searchable_searchMode, 0);
        mLabelId = a.getResourceId(styleable.Searchable_label, 0);
        mHintId = a.getResourceId(styleable.Searchable_hint, 0);
        mIconId = a.getResourceId(styleable.Searchable_icon, 0);
        mSearchButtonText = a.getResourceId(
                styleable.Searchable_searchButtonText, 0);
        mSearchInputType = a.getInt(styleable.Searchable_inputType, 
                InputType.TYPE_CLASS_TEXT |
                InputType.TYPE_TEXT_VARIATION_NORMAL);
        mSearchImeOptions = a.getInt(styleable.Searchable_imeOptions, 
                EditorInfo.IME_ACTION_SEARCH);
        mIncludeInGlobalSearch = a.getBoolean(
                styleable.Searchable_includeInGlobalSearch, false);
        mQueryAfterZeroResults = a.getBoolean(
                styleable.Searchable_queryAfterZeroResults, false);
        mAutoUrlDetect = a.getBoolean(
                styleable.Searchable_autoUrlDetect, false);

        mSettingsDescription = a.getString(
                styleable.Searchable_searchSettingsDescription);
        mSuggestAuthority = a.getString(
                styleable.Searchable_searchSuggestAuthority);
        mSuggestPath = a.getString(
                styleable.Searchable_searchSuggestPath);
        mSuggestSelection = a.getString(
                styleable.Searchable_searchSuggestSelection);
        mSuggestIntentAction = a.getString(
                styleable.Searchable_searchSuggestIntentAction);
        mSuggestIntentData = a.getString(
                styleable.Searchable_searchSuggestIntentData);
        mSuggestThreshold = a.getInt(
                styleable.Searchable_searchSuggestThreshold, 0);

        mVoiceSearchMode = 
            a.getInt(styleable.Searchable_voiceSearchMode, 0);
        // TODO this didn't work - came back zero from YouTube
        mVoiceLanguageModeId = 
            a.getResourceId(styleable.Searchable_voiceLanguageModel, 0);
        mVoicePromptTextId = 
            a.getResourceId(styleable.Searchable_voicePromptText, 0);
        mVoiceLanguageId = 
            a.getResourceId(styleable.Searchable_voiceLanguage, 0);
        mVoiceMaxResults = 
            a.getInt(styleable.Searchable_voiceMaxResults, 0);
    ...
    public static class ActionKeyInfo implements Parcelable {
        ...
        public ActionKeyInfo(Context activityContext, AttributeSet attr) {
            TypedArray a = activityContext.obtainStyledAttributes(attr,
                    styleable.SearchableActionKey);

            mKeyCode = a.getInt(
                    styleable.SearchableActionKey_keycode, 0);
            mQueryActionMsg = a.getString(
                    styleable.SearchableActionKey_queryActionMsg);
            mSuggestActionMsg = a.getString(
                    styleable.SearchableActionKey_suggestActionMsg);
            mSuggestActionMsgColumn = a.getString(
                    styleable.SearchableActionKey_suggestActionMsgColumn);
            a.recycle();
