...
// This code is copied from frameworks/base/core/java/android/server/search/Searchables.java
...
public class Searchables {
    ...
    // TODO: this should be unhidden in SearchManager.
    private static final String INTENT_ACTION_GLOBAL_SEARCH = "android.search.action.GLOBAL_SEARCH";
    ...
    public void buildSearchableList() {
        ...
        Intent globalSearchIntent = new Intent(INTENT_ACTION_GLOBAL_SEARCH);
...
// TODO: need a way to do this outside the framework
...
//        pm.replacePreferredActivity(filter, bestMatch, set, component);
    ...
    private static ComponentName getPreferredWebSearchActivity(Context context) {
        ...
        // TODO: need to handle the case with multiple web search providers
        if (ri == null /* || ri.activityInfo.name.equals(ResolverActivity.class.getName()) */) {
            ...
            String[] preferredActivities = context.getResources().getStringArray(
                    R.array.default_web_search_providers);
